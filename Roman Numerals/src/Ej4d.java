...
public class Ej4d {
    ...
    private static String assignRoman(String substring, int i) {
        ...
        switch (Integer.parseInt(substring)) {
            case 1 -> result = car1;
            case 2 -> result = car1 + car1;
            case 3 -> result = car1 + car1 + car1;
            case 4 -> result = car1 + car2;
            case 5 -> result = car2;
            case 6 -> result = car2 + car1;
            case 7 -> result = car2 + car1 + car1;
            case 8 -> result = car2 + car1 + car1 + car1;
            case 9 -> result = car1 + car3;
        }
        return result;
    }
